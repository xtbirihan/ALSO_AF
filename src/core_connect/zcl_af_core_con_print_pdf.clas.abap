class ZCL_AF_CORE_CON_PRINT_PDF definition
  public
  final
  create public .
...
public section.
  ...
  methods CONSTRUCTOR
    importing
      ...
      !IS_PRINT_PDF_PARAMS type ZAF_S_CON_PRINT_PDF_PARAMS
    raising
      ZCX_AF_CORE_OUTPUT .
protected section.

  data WA_PRINT_PARAMS type ZAF_S_CON_PRINT_PDF_PARAMS .
...
private section.
  ...
  methods GET_ADS_PATH
    raising
      ZCX_AF_CORE_OUTPUT .
  methods TRANSFER_PDF
    importing
      !IM_PDF_XSTRING type XSTRING
    raising
      ZCX_AF_CORE_OUTPUT .
...
CLASS ZCL_AF_CORE_CON_PRINT_PDF IMPLEMENTATION.
...
************************************************************************
    ...
    CALL METHOD zcl_af_core_logger=>write_log
      EXPORTING
        ...
        im_ext_ident = '> START - ZCL_AF_CORE_CON_PRINT'.

    me->wa_print_params = im_wa_print_pdf_params.
...
************************************************************************
*&  Description (short)
*&  PDF-XSTRING-Datenstrom an ADS zur Verarbeitung senden
************************************************************************
    ...
    TRANSFER im_pdf_xstring TO me->destfile.
...
************************************************************************
    ...
    DO me->wa_print_params-copies TIMES.
      ...
      " PDL-Type PCL Generic
      CALL METHOD me->transfer_pdf
        EXPORTING
          im_pdf_xstring = l_wa_formoutput-pdf.
